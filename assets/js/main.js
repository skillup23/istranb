/*=============== OPEN NAV MOBILE ===============*/
const buttonMenu = document.querySelector('.header__open-menu');
const navMenuMobile = document.querySelector('.main__nav-left');
const navOverlay = document.querySelector('.main__nav-overlay');
const bodyStycky = document.querySelector('body');

function openMenu() {
  navMenuMobile.classList.toggle('is-active');
...
function closeMenu() {
  navMenuMobile.classList.remove('is-active');
...
// sr.reveal(
//   `.home__title-box, .home__subtitle, .subscribe__container, .footer__container`
// );
// sr.reveal(`.section__title, .footer__info`, { delay: 500 });
// sr.reveal(`.home__search`, { delay: 600 });
// sr.reveal(`.home__value, .info, .services`, { delay: 700 });
// sr.reveal(`.home__video`, { delay: 800, origin: "bottom" });
